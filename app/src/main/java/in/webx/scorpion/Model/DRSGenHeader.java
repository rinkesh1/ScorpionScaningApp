...
public class DRSGenHeader extends RealmObject {
    ...
    @SerializedName("manualDrsNo")
    @Expose
    private String manualDrsNo;
    ...
    public String getManualDrsNo() {
        return manualDrsNo;
    }

    public void setManualDrsNo(String manualDrsNo) {
        this.manualDrsNo = manualDrsNo;
    }
