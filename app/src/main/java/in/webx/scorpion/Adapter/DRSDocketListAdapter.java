...
import in.webx.scorpion.activity.DRSBarcodePickupActivity;
import in.webx.scorpion.util.SharedPreference;

public class DRSDocketListAdapter extends RecyclerView.Adapter<DRSDocketListAdapter.ThcDocketListViewHolder> {

    ArrayList<ThcDocketList_Tbl> thcDocketListTbls;
    DRSBarcodePickupActivity thcBarcodePickupActivity;
    boolean stetus;

    public DRSDocketListAdapter(ArrayList<ThcDocketList_Tbl> thcDocketListTbls, DRSBarcodePickupActivity thcBarcodePickupActivity, boolean stetus) {
    ...
    public void onBindViewHolder(@NonNull ThcDocketListViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(v -> thcBarcodePickupActivity.showBarcodeList(stetus,thcDocketListTbls.get(position).getDockNo()));
